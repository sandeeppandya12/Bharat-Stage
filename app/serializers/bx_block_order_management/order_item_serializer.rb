...
module BxBlockOrderManagement
  class OrderItemSerializer < BuilderBase::BaseSerializer
    attributes(:id, :order_management_order_id, :quantity, :unit_price, :total_price, :old_unit_price, :status,
      :catalogue_id, :catalogue_variant_id, :order_status_id, :placed_at, :confirmed_at, :in_transit_at, :delivered_at, :cancelled_at, :refunded_at, :manage_placed_status, :manage_cancelled_status, :created_at, :updated_at)
